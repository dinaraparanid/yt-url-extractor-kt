...
import com.paranid5.yt_url_extractor_kt.utils.extensions.receiveTimeout
...
/**
 * Extracts the YouTube video [StreamData] by the given [ytUrl]
 *
 * @param context local [Context] required to run [JsEvaluator]
 * during the process of deciphering media URLs
 *
 * @param ytUrl The YouTube URL from which to extract the video files and metadata
 *
 * @return The result of the operation,
 * either a successful result containing the video files and metadata
 * or a corresponding [YtException] indicating a failure.
 */
